/*write a program which accept number from uders and range of position from user.Toggle all bits from that range
Input:  897 9   13
         Toggle bits from position 9 to 13 of input number is 879.........*/
